...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://drupaluser:drupalpw@localhost/drupaldb?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://civicuser:civipw@localhost:3306/civicdb?new_link=true');
  }
}
...
$civicrm_root = '/home/drupal/drupal/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/home/drupal/drupal/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'https://cctest.ga/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '95b3d480d60ec6f9b50080b151da772d');
}
...
// define( 'CIVICRM_MAIL_LOG', '/home/drupal/drupal/sites/default/files/civicrm/templates_c//mail.log');
// }
